...
class InputModifier(object):
    ...
    def fourStyleFamily(self, position, suffix=None):
        ...
        temp = open(pathToXML, "r")
        xml = temp.read()

        # make the chages
        xml = xml.replace("Input Sans", "Input"+suffixWithSpace)
        xml = xml.replace("InputSans", "Input"+suffixWithoutSpace)
    ...
    def changeNames(self, suffix=None):
        ...
        for name in f['name'].names:
            name.string = name.string.replace("Input Sans", "Input Sans"+suffixWithSpace)
            name.string = name.string.replace("InputSans", "InputSans"+suffixWithoutSpace)
            name.string = name.string.replace("Input Serif", "Input Serif"+suffixWithSpace)
            name.string = name.string.replace("InputSerif", "InputSerif"+suffixWithoutSpace)
            name.string = name.string.replace("Input Mono", "Input Mono"+suffixWithSpace)
            name.string = name.string.replace("InputMono", "InputMono"+suffixWithoutSpace)
            #name.string = name.string.replace("Input", "Input"+suffixWithoutSpace)
